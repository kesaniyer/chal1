...
const b_url = "/benchmark?url=http://localhost:3000/benchmark?internal=flag";
...
app.post('/api/benchmark', (req, res) => {
    const targetUrl = "http://localhost:3000/benchmark?internal=flag";
...
app.get('/benchmark', async (req, res) => {
   if (req.query['internal'] === 'flag') {
    ...
    if (targetUrl === 'http://localhost:3000/benchmark?internal=flag') {
